...
function Banner() {
  ...
  const imageX = isMediumScreen? useTransform(scrollYProgress, [0, 1], [0, 160]): useTransform(scrollYProgress, [0, 1], [0, 280]) ;
  ...
  return (
    <div className='bg-brand-primary flex flex-col content-center md:flex-row overflow-x-hidden overflow-y-hidden items-center pb-8 md:pb-20 h-screen md:h-fit sticky top-0'>
      ...
      <motion.h1 style={{x:textX}} className='text-4xl md:text-5xl text-center md:text-right text-white font-light'>Let&apos;s create <br />eye-catching <br/><span className='font-semibold text-5xl md:text-7xl'>Audience</span></motion.h1>
