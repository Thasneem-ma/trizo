...
function page() {
  return (
    <div className=' flex-col gap-10 md:flex-row items-center scroll-smooth  py-12 px-14 md:px-44 space-x-6'>
      ...
      <div className='flex flex-col lg:flex-row justify-between gap-10 pt-20 w-full space-x-3 items-center'>
      ...
      <div className='flex flex-col lg:flex-row justify-between gap-10 pt-32 w-full space-x-3 items-center'>
        <div>
      ...
      <div className='flex flex-col lg:flex-row  gap-2 py-20 px-2 space-x-3 items-center text-center'>
        <div className='w-fit  items-center flex flex-col gap-2.5 content-center shadow-green-100 shadow-lg p-5 hover:shadow-lg rounded-sm '>
