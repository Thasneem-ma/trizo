        ...
        <div className=' flex-col md:flex-row items-center  py-12 px-16 md:px-44 space-x-6'>
            ...
            <div className='flex  items-center  flex-col lg:flex-row py-36 '>
                <div className=''>
                    ...
                    <h1 className='text-brand-secondary font-bold text-6xl md:text-5xl'>TRIZO IS A CREATIVE DIGITAL AGENCY</h1>
                </div>
            ...
            <div class="container overflow-hidden relative">
                <div className='flex flex-col lg:flex-row justify-center gap-4 text-6xl md:8xl'>
                    <h1 class="text-slate-400">WEARE</h1>
                    <h1 class="font-bold">TRIZO</h1>
                </div>
                <h1 class="text-sm text-center p-3 text-slate-400">
            ...
            <div className='flex flex-col lg:flex-row  gap-2 py-20 px-5 md:px-0 space-x-3  text-start'>
                <div className='items-start flex flex-col gap-2.5 content-center shadow-green-100 shadow-lg p-5 hover:shadow-lg rounded-sm '>
                    <h1 className='text-3xl font-bold text-green-700 p-3'>Why Choose Us?</h1>
                    <h1 className=' text-sm text-slate-600'>Webmax Digital Solutions LLP is a Full-Service Digital Agency Based in India & GCC. Webmax provide market research, event marketing, Media producations, digital marketing, web development, app development, brand development, motion graphics, content writing & print manufacture.</h1>
                ...
                <div className='items-start flex flex-col gap-2.5 content-center shadow-green-100 shadow-lg p-5 hover:shadow-lg rounded-sm '>
                    <h1 className='text-3xl font-bold text-green-700 p-3'>Our Team Persuit</h1>
                    <h1 className=' text-sm text-slate-600'>Webmax Digital Solutions LLP is a Full-Service Digital Agency Based in India & GCC. Webmax provide market research, event marketing, Media producations, digital marketing, web development, app development, brand development, motion graphics, content writing & print manufacture.</h1>
                    <h1 className='text-sm py-10 text-slate-600'>Our clients are involved in every step along the way. because we are wired for long-term contracts and retained customers.</h1>
                </div>
            </div>
